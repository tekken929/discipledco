  ...
  return (
    <div className="fixed bottom-8 right-8 z-[9999] animate-in slide-in-from-bottom duration-500">
      <button
        ...
        className={`relative bg-gradient-to-br ${currentMessage.color} backdrop-blur-sm rounded-2xl p-6 shadow-2xl w-[280px] flex flex-col items-center justify-center text-center hover:scale-105 transition-transform duration-300 border-4 border-white/30`}
      >
