        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <a
              ...
              className="flex items-center gap-1 text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800"
            >
            ...
            <Link
              to="/app"
              className="flex items-center gap-1 bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-xs font-bold px-2 py-1.5 rounded-lg hover:bg-gray-700 dark:hover:bg-gray-100 transition-colors"
            >
            ...
            <div ref={settingsRef} className="relative">
              <button
                ...
                className="flex items-center gap-1 p-2 rounded-lg text-sm font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                aria-label="Settings"
              >
