...
const ACCENT: Record<AccentKey, {
  ...
  amber: {
    badgeBg: 'bg-amber-200 dark:bg-amber-900/60', badgeText: 'text-amber-800 dark:text-amber-300',
    convBorder: 'border-amber-300 dark:border-amber-800/60', convBg: 'bg-amber-100/60 dark:bg-amber-950/30', convTitle: 'text-amber-900 dark:text-amber-200',
    translationBg: 'bg-amber-200 dark:bg-amber-900/60', translationText: 'text-amber-800 dark:text-amber-300',
    bookIcon: 'text-amber-700 dark:text-amber-400',
    sectionBg: 'bg-amber-50/50 dark:bg-amber-950/20', sectionBorder: 'border-amber-300/50 dark:border-amber-800/50',
    headerBg: 'bg-amber-200/60 dark:bg-amber-900/50', headerText: 'text-amber-900 dark:text-amber-200',
    verseAltBg: 'bg-amber-100/40 dark:bg-amber-950/15', leftBar: 'border-l-amber-500 dark:border-l-amber-600',
  },
  blue: {
    badgeBg: 'bg-blue-200 dark:bg-blue-900/60', badgeText: 'text-blue-800 dark:text-blue-300',
    convBorder: 'border-blue-300 dark:border-blue-800/60', convBg: 'bg-blue-100/60 dark:bg-blue-950/30', convTitle: 'text-blue-900 dark:text-blue-200',
    translationBg: 'bg-blue-200 dark:bg-blue-900/60', translationText: 'text-blue-800 dark:text-blue-300',
    bookIcon: 'text-blue-700 dark:text-blue-400',
    sectionBg: 'bg-blue-50/50 dark:bg-blue-950/20', sectionBorder: 'border-blue-300/50 dark:border-blue-800/50',
    headerBg: 'bg-blue-200/60 dark:bg-blue-900/50', headerText: 'text-blue-900 dark:text-blue-200',
    verseAltBg: 'bg-blue-100/40 dark:bg-blue-950/15', leftBar: 'border-l-blue-500 dark:border-l-blue-600',
  },
  green: {
    badgeBg: 'bg-green-200 dark:bg-green-900/60', badgeText: 'text-green-800 dark:text-green-300',
    convBorder: 'border-green-300 dark:border-green-800/60', convBg: 'bg-green-100/60 dark:bg-green-950/30', convTitle: 'text-green-900 dark:text-green-200',
    translationBg: 'bg-green-200 dark:bg-green-900/60', translationText: 'text-green-800 dark:text-green-300',
    bookIcon: 'text-green-700 dark:text-green-400',
    sectionBg: 'bg-green-50/50 dark:bg-green-950/20', sectionBorder: 'border-green-300/50 dark:border-green-800/50',
    headerBg: 'bg-green-200/60 dark:bg-green-900/50', headerText: 'text-green-900 dark:text-green-200',
    verseAltBg: 'bg-green-100/40 dark:bg-green-950/15', leftBar: 'border-l-green-500 dark:border-l-green-600',
  },
  rose: {
    badgeBg: 'bg-rose-200 dark:bg-rose-900/60', badgeText: 'text-rose-800 dark:text-rose-300',
    convBorder: 'border-rose-300 dark:border-rose-800/60', convBg: 'bg-rose-100/60 dark:bg-rose-950/30', convTitle: 'text-rose-900 dark:text-rose-200',
    translationBg: 'bg-rose-200 dark:bg-rose-900/60', translationText: 'text-rose-800 dark:text-rose-300',
    bookIcon: 'text-rose-700 dark:text-rose-400',
    sectionBg: 'bg-rose-50/50 dark:bg-rose-950/20', sectionBorder: 'border-rose-300/50 dark:border-rose-800/50',
    headerBg: 'bg-rose-200/60 dark:bg-rose-900/50', headerText: 'text-rose-900 dark:text-rose-200',
    verseAltBg: 'bg-rose-100/40 dark:bg-rose-950/15', leftBar: 'border-l-rose-500 dark:border-l-rose-600',
  },
  sky: {
    badgeBg: 'bg-sky-200 dark:bg-sky-900/60', badgeText: 'text-sky-800 dark:text-sky-300',
    convBorder: 'border-sky-300 dark:border-sky-800/60', convBg: 'bg-sky-100/60 dark:bg-sky-950/30', convTitle: 'text-sky-900 dark:text-sky-200',
    translationBg: 'bg-sky-200 dark:bg-sky-900/60', translationText: 'text-sky-800 dark:text-sky-300',
    bookIcon: 'text-sky-700 dark:text-sky-400',
    sectionBg: 'bg-sky-50/50 dark:bg-sky-950/20', sectionBorder: 'border-sky-300/50 dark:border-sky-800/50',
    headerBg: 'bg-sky-200/60 dark:bg-sky-900/50', headerText: 'text-sky-900 dark:text-sky-200',
    verseAltBg: 'bg-sky-100/40 dark:bg-sky-950/15', leftBar: 'border-l-sky-500 dark:border-l-sky-600',
  },
  slate: {
    badgeBg: 'bg-slate-200 dark:bg-slate-800/70', badgeText: 'text-slate-800 dark:text-slate-200',
    convBorder: 'border-slate-300 dark:border-slate-700/70', convBg: 'bg-slate-100/60 dark:bg-slate-900/40', convTitle: 'text-slate-900 dark:text-slate-200',
    translationBg: 'bg-slate-200 dark:bg-slate-800/70', translationText: 'text-slate-700 dark:text-slate-300',
    bookIcon: 'text-slate-600 dark:text-slate-400',
    sectionBg: 'bg-slate-50/50 dark:bg-slate-900/20', sectionBorder: 'border-slate-300/50 dark:border-slate-700/50',
    headerBg: 'bg-slate-200/60 dark:bg-slate-800/50', headerText: 'text-slate-800 dark:text-slate-200',
    verseAltBg: 'bg-slate-100/40 dark:bg-slate-900/15', leftBar: 'border-l-slate-500 dark:border-l-slate-600',
  },
  orange: {
    badgeBg: 'bg-orange-200 dark:bg-orange-900/60', badgeText: 'text-orange-800 dark:text-orange-300',
    convBorder: 'border-orange-300 dark:border-orange-800/60', convBg: 'bg-orange-100/60 dark:bg-orange-950/30', convTitle: 'text-orange-900 dark:text-orange-200',
    translationBg: 'bg-orange-200 dark:bg-orange-900/60', translationText: 'text-orange-800 dark:text-orange-300',
    bookIcon: 'text-orange-700 dark:text-orange-400',
    sectionBg: 'bg-orange-50/50 dark:bg-orange-950/20', sectionBorder: 'border-orange-300/50 dark:border-orange-800/50',
    headerBg: 'bg-orange-200/60 dark:bg-orange-900/50', headerText: 'text-orange-900 dark:text-orange-200',
    verseAltBg: 'bg-orange-100/40 dark:bg-orange-950/15', leftBar: 'border-l-orange-500 dark:border-l-orange-600',
  },
  red: {
    badgeBg: 'bg-red-200 dark:bg-red-900/60', badgeText: 'text-red-800 dark:text-red-300',
    convBorder: 'border-red-300 dark:border-red-800/60', convBg: 'bg-red-100/60 dark:bg-red-950/30', convTitle: 'text-red-900 dark:text-red-200',
    translationBg: 'bg-red-200 dark:bg-red-900/60', translationText: 'text-red-800 dark:text-red-300',
    bookIcon: 'text-red-700 dark:text-red-400',
    sectionBg: 'bg-red-50/50 dark:bg-red-950/20', sectionBorder: 'border-red-300/50 dark:border-red-800/50',
    headerBg: 'bg-red-200/60 dark:bg-red-900/50', headerText: 'text-red-900 dark:text-red-200',
    verseAltBg: 'bg-red-100/40 dark:bg-red-950/15', leftBar: 'border-l-red-500 dark:border-l-red-600',
  },
};
