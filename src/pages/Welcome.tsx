      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="theme-card rounded-2xl shadow-xl p-8 md:p-12 mb-8 transition-colors">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
            Enjoy music and songs while you explore. The music player will continue playing as you navigate through the site. All of these songs are originally produced and quote the Psalms.
          </p>
          <Link
            to="/music"
