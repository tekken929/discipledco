      ...
      <div className="max-w-6xl mx-auto theme-card rounded-2xl shadow-xl p-8 md:p-12 transition-colors">
        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900 dark:to-orange-800 rounded-xl p-6 border-2 border-orange-200 dark:border-orange-700 flex flex-col h-full hover:shadow-xl transition-all hover:scale-105">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 dark:from-teal-900 dark:to-teal-800 rounded-xl p-6 border-2 border-teal-200 dark:border-teal-700 flex flex-col h-full hover:shadow-xl transition-all hover:scale-105">
