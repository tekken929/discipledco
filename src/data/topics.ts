...
export const topics: Topic[] = [
  {
    ...
    references: [
      ...
      },
      {
        ...
        chapter: 7,
        verse: '3-4',
        text: 'The husband should give to his wife her conjugal rights, and likewise the wife to her husband. For the wife does not have authority over her own body, but the husband does. Likewise the husband does not have authority over his own body, but the wife does.'
      },
      {
        book: 'Colossians',
        chapter: 3,
  ...
  },
  {
    ...
    references: [
      ...
      },
      {
        ...
        chapter: 1,
        verse: '14-15',
        text: 'But each person is tempted when he is lured and enticed by his own desire. Then desire when it has conceived gives birth to sin, and sin when it is fully grown brings forth death.'
      },
      {
        book: 'Philippians',
        chapter: 4,
