    ...
    lessons: [
      {
        id: 'm8-l1',
        title: 'Grace & Mercy',
        preview: 'Mercy is God not giving us what we deserve. Grace is God giving us what we could never earn. Both meet most clearly at the cross, where His justice and His love are satisfied in Christ.',
        expanded: 'R.C. Sproul used to say that grace is not God lowering His standards — it is God meeting those standards Himself in the person of His Son. That distinction matters. Mercy is God withholding the judgment our sins have earned. If we are honest about who we are apart from Christ, none of us would stand on our own. Every sin is an offense against a perfectly holy God, and His justice demands that sin be dealt with. Grace is the other side of that coin. God does not merely withhold punishment — He gives us righteousness, adoption, and eternal life that we could never earn. Ephesians 2:8-9 makes this unmistakable: salvation is by grace through faith, not of works, so that no one may boast. The hardest part is accepting that we contribute nothing. We want to earn it. We want to feel like we did enough. But grace, by definition, is unmerited favor. When that truth moves from your head into how you actually live, it changes everything — your worship, your humility, and your patience with others.',
        keyTakeaway: 'Grace is not God lowering His standard. It is God meeting that standard Himself in Christ.'
      },
      {
        id: 'm8-l2',
        title: 'Faith',
        preview: 'Biblical faith is not blind optimism. It is trust grounded in evidence — confidence in the character of God and the historical reality of what He has done in Christ.',
        expanded: 'Hebrews 11:1 defines faith as "the substance of things hoped for, the evidence of things not seen." Wes Huff regularly points out that biblical faith is not a leap in the dark — it is trust placed in a Person who has proven trustworthy. Abraham left his homeland because God had already demonstrated His faithfulness. Noah built the ark because God had already spoken with authority. These were not naive people. They had sufficient evidence to act. Faith, in the biblical sense, always involves a corresponding action. It is not enough to agree intellectually that God exists. James says even the demons believe that. Saving faith is trust that commits — the kind that rests in Christ alone for salvation and then orders your life around what He has said. The feeling of certainty often follows the step of obedience, not the other way around.',
        keyTakeaway: 'Faith is not the absence of doubt. It is trust placed in a trustworthy God, demonstrated by action.'
      },
      {
        id: 'm8-l3',
        title: 'Sin',
        preview: 'Sin is not just bad behavior. It is a fundamental orientation of the heart away from God — and understanding what it actually is makes the gospel make sense.',
        expanded: 'R.C. Sproul defined sin as "cosmic treason" against a perfectly holy God. That language sounds extreme until you read Romans 3:23 — all have sinned and fall short of the glory of God. The root of sin is not bad behavior. It is the choice to be our own authority instead of God\'s. That is what happened in Genesis 3 — not merely disobedience, but a declaration of self-sovereignty. Every sin since traces back to that same impulse: I know better than God. This matters because behavior-based morality never fixes the real problem. You can clean up your external conduct and still have a heart entirely oriented away from God. The gospel addresses the root, not just the fruit. Sin separates us from God (Isaiah 59:2), and its wages are death (Romans 6:23). That is why salvation cannot be self-improvement. It requires a new heart, a new nature, and a substitute who can bear the judgment we deserve.',
        keyTakeaway: 'Sin is not primarily about behavior — it is about who rules your heart. The gospel addresses the root, not just the fruit.'
      },
      {
        id: 'm8-l4',
        title: 'Purpose',
        preview: 'You were not created to be comfortable. You were created to know God, reflect His character, and participate in what He is doing in the world.',
        expanded: 'The Westminster Shorter Catechism opens with the question: "What is the chief end of man?" The answer: to glorify God and enjoy Him forever. That sounds abstract until you understand what glorifying God actually means — living in such a way that who He is becomes visible through you. Your work, your relationships, your creativity, your suffering, your joy — all of it has the potential to display the character of God. Ephesians 2:10 says we are God\'s workmanship, created in Christ Jesus for good works prepared beforehand. You were not built for boredom or endless self-optimization. You were built for participation in something that matters far beyond your own story. Purpose is not found by looking inward. It is found by being placed into God\'s redemptive work.',
      ...
      },
      {
        ...
        preview: 'The Bible teaches there is a real, ongoing spiritual battle. Understanding this does not produce fear — it produces vigilance and grounding in truth.',
        expanded: 'Ephesians 6:12 is explicit: our struggle is not against flesh and blood, but against spiritual forces of evil in heavenly places. This is not mythology. It is Scripture\'s explanation for why the world is the way it is — why truth is resisted, why darkness holds such sway, why the same patterns of destruction repeat across every culture and generation. 1 Peter 5:8 warns that the devil prowls like a roaring lion seeking someone to devour. But you do not fight this battle by being theatrical or aggressive. You fight it by knowing who you are in Christ, staying grounded in Scripture, staying in prayer, and standing firm. 1 John 4:4 reminds us that the One who is in us is greater than the one who is in the world. The battle is real. The outcome is not in question — Christ has already disarmed the rulers and authorities at the cross (Colossians 2:15).',
        keyTakeaway: 'You fight spiritual warfare not by being fearful, but by being grounded in what is true.'
      },
      {
        id: 'm8-l6',
        title: 'Identity in Christ',
        preview: 'Your identity is no longer defined by your past, your failures, or what others think of you. In Christ, you are who God says you are — and that declaration is unchangeable.',
        expanded: '2 Corinthians 5:17 says that if anyone is in Christ, he is a new creation. The old has passed away; the new has come. In Christ, you are forgiven, adopted, and loved with a love that does not fluctuate based on your performance. You have been given the Holy Spirit as a guarantee (Ephesians 1:13-14). You have access to God as a Father, not as a distant judge. You are seated with Christ in heavenly places (Ephesians 2:6). These are not aspirational phrases — they are legal realities that became true the moment you trusted Jesus. Most Christians know these truths intellectually but live as if none of them are real. Sanctification is, in large part, the process of learning to actually believe what God has already declared about you. Your identity is not something you earn. It is something you receive and then learn to live from.',
